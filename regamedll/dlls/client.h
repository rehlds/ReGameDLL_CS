...
#ifdef REGAMEDLL_API
void SendSayMessage_OrigFunc(CBasePlayer *pPlayer, BOOL teamonly, const char *p, const char *pszFormat, const char *pszConsoleFormat, bool bSenderDead, const char *placeName, bool consoleUsesPlaceName);
...
void SendSayMessage(CBasePlayer *pPlayer, BOOL teamonly, const char *p, const char *pszFormat, const char *pszConsoleFormat, bool bSenderDead, const char *placeName, bool consoleUsesPlaceName);
